...
const DROP_V6: &str = "PRAGMA foreign_keys=OFF; DROP TABLE IF EXISTS operation_readset_receipts; DROP TABLE IF EXISTS responsibility_receipts; DROP TABLE IF EXISTS responsibility_events; DROP TABLE IF EXISTS task_collaborators; DROP TABLE IF EXISTS task_responsibilities; DROP TABLE IF EXISTS person_agent_bindings; DROP TABLE IF EXISTS persons; DROP TABLE source_content_reviews; DROP TABLE conversation_workstreams; DROP TABLE session_workstreams; DROP TRIGGER session_identity_no_update; DROP TRIGGER workstream_claim_exclusive_insert; DROP TRIGGER workstream_claim_exclusive_update; DELETE FROM schema_migrations WHERE version>=6; PRAGMA user_version=5;";
