...
use awr_team_pg::{admit_live_fence, unknown_effect_retains_resources, 
...
fn admit_live_fence_refuses_stale_after_handoff_or_expiry() {
    ...
    assert!(admit_live_fence(1, 1, 2, true).is_err(), "handoff advanced live fence");
    assert!(admit_live_fence(1, 2, 2, true).is_err(), "execution kept old fence");
