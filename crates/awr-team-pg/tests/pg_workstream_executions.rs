...
async fn schema_twelve_preserves_legacy_executions_and_failed_migration_is_atomic() {
    ...
    admin.batch_execute("DROP TABLE IF EXISTS awr_team.planning_publish_receipts; DROP TABLE IF EXISTS awr_team.planning_approvals; DROP TABLE IF EXISTS awr_team.planning_candidate_history; DROP TABLE IF EXISTS awr_team.planning_candidates; DROP TABLE IF EXISTS awr_team.planning_suggestions; DROP TABLE IF EXISTS awr_team.project_access_changes; DROP TABLE IF EXISTS awr_team.execution_attributions; DROP TABLE IF EXISTS awr_team.operator_quarantines; DROP TABLE IF EXISTS awr_team.backup_operations; DROP TABLE IF EXISTS awr_team.history_migrations; DROP TABLE IF EXISTS awr_team.access_changes;
